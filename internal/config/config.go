...
func (c Config) String() string {
	...
	fmt.Fprintf(&b, "%s: %s\n", GATEWAY_ACTIVE_CONNECTION_REGISTRAR_POLL_MIN_DELAY, string(c.GatewayActiveConnectionRegistrarPollMinDelay))
	fmt.Fprintf(&b, "%s: %s\n", GATEWAY_ACTIVE_CONNECTION_REGISTRAR_POLL_MAX_DELAY, string(c.GatewayActiveConnectionRegistrarPollMaxDelay))
